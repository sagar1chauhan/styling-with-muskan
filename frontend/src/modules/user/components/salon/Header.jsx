    ...
    <div className="max-w-6xl mx-auto px-4 py-3">
      ...
      <div className="flex items-center justify-between mb-2">
        <button
          ...
          className="flex items-center gap-1.5 text-sm hover:bg-accent px-2 py-1 rounded-lg transition-colors group"
        >
          <MapPin className="w-4 h-4 text-primary group-hover:scale-110 transition-transform" />
          <span className="font-medium truncate max-w-[150px] md:max-w-[200px]">
            {user?.address ? `${user.address.houseNo}, ${user.address.area}` : "Select Location"}
          </span>
